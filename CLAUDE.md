...
| 20 | `docs/components/20_schluessel_tresor.md` | Schlüssel-Tresor-Backlog · **Spec/Konzept-Karte** (2026-06-20, Klaus-Auftrag), Priorität hoch. Lokal verschlüsselter Tresor IM Repo für die SBKIM-Identität (nodeId + privater Knotenschlüssel + eigene Spore), gegen Identitäts-Wandern. Krypto-Kern aus Modul 02 (PBKDF2-SHA256 ≥600k + AES-GCM-256), Auto-Abfrage zweistufiges Passwort (mit Wiederholung), **Shamir-Recovery über das Passwort** (k von N, Nutzer verwahrt Anteile, System fordert aktiv ein). Vorbilder: Mein-Tresor, BLP „Geheim-Fach". Datenschutz: nur Identität/Schlüssel, kein PII, nie übers Netz. **Spec zuerst (Klaus) — Bau wartet auf Klaus' Prüfung der Karte.** |
