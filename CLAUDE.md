...
| 18 | `docs/components/18_tool_pwa.md` | Tool-PWA-Backlog · **Schablone** (2026-05-25, Stub-Anlage), Priorität mittel (nach App-Freigabe). Klaus' Idee bei Sichttest 17: SIEGEL-Slot soll später als Tool-PWA-Container für Andocken + Sporen-Installation gestaltet werden. Karte 18 Stub mit Vokabular + Sub-Bereiche-Skizze (a Andock-Geste, b Sporen-Installation, c Identitäts-Wechsel, d Backup, e Self-Apoptose) + offenen Spec-Fragen. Brief: `docs/sessions/BRIEF_SPEC_18_TOOL_PWA.md`. Spec-Sitzung 18 läuft NACH App-Freigabe (nach mindestens 5–10 Endnutzer-Sichtproben). |
