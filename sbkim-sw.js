 ...
 *
 * SAGE-PAGE-ROOT-KOPIE (Bau Sage-Page-Refactor 2026-05-21).
 * Variante 3a aus Karte 09 — Sage-Page hat keinen App-SW, daher
 * ist diese Datei der einzige SW im Sage-Page-Repo-Root. Inhalt 1:1
 * von src/sbkim-sw.js gespiegelt; KEIN Refactoring der SW-Logik in
 * dieser Bau-Sitzung. Bei Pflege-Sitzungen, die src/sbkim-sw.js
 * ändern, muss diese Kopie nachgezogen werden.
 *
 * Cache-Bust: bei einem Bump dieser Datei den Sage-Page-Sichttest
 * mit Service-Worker-Cleanup durchführen (chrome://serviceworker-
 * internals/ Unregister + „Clear site data" + Tab-Reopen). Siehe
 * Brief „Bau Sage-Page-Refactor" § Stolperfalle 1.
 *
