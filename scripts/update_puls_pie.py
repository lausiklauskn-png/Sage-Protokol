...
Liest status.json (modules + schutzBacklog), zaehlt pro score-Wert
und ersetzt den existierenden ```mermaid / pie showData / ...```-
Block in docs/PULS.md. Datum kommt aus status.json.lastUpdated.
