...
(function (global) {
  ...
  function buildAiPrompt(query) {
    ...
    return [
      ...
      "  Spezial-Anbieter, Fachhändler, Apotheken, Marktplätze (z. B. Amazon).",
      "- Nenne auch konkrete Produkt-/Markennamen und relevante Fachbegriffe (z. B. Wirkstoffe,",
      "  Modellnamen), selbst wenn sie in meiner Frage nicht wörtlich vorkommen.",
      "- Betrachte mehrere Blickwinkel der Frage (allgemein + nach Eigenschaft/Wirkstoff + nach",
      "  Anwendung), damit auch gute, aber selten genannte Treffer dabei sind. Ich sortiere selbst.",
      "",
