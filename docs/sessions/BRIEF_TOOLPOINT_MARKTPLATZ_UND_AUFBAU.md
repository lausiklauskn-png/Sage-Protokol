...
Repos auf EINER Internetseite und bieten sie als Pilze/Gerichte an. Privat-Nutzer
laden Tools gegen kleine Gebühr; Programmierer listen ihre eigenen PWAs gegen
kleinen Monatsbeitrag (~1 €) und werden über die Suche gefunden. Keine Garantie
für fremde Apps — Vorbereitung zuerst."

```
Du bist eine Spec-/Bau-Sitzung im Sage-Mycel. Freibrief gilt (CLAUDE.md
...
SBKIM-Werkzeuge/Repos bündelt und als „Pilze/Gerichte" einladend anbietet,
plus Vorbereitung eines kleinen Marktplatzes. Heimat: SB-KIMTool-Point
...
GESCHÄFTSMODELL-VISION (Klaus 2026-06-26 — Pilz-Schicht 2 / Marktplatz,
...
- Anbieter-Listing: Programmierer können ihre eigenen PWAs/Repos/Seiten LISTEN
  ...
  steht nur der Link.
- Entdeckung über die Such-Tools: jemand sucht „ich brauche so eine App" → die
...
DREI GETRENNTE RÄUME (Vier-Schichten-Lesart, CLAUDE.md):
...
- Pilz-Raum (Schicht 2): die Werkzeuge als sichtbare, benannte Angebote. Akquise
  gehört HIERHER, nicht ins Mycel — benannt, sichtbar, nutzer-ausgelöst.
...
fremdem Repo mit Klaus Eigentum + Zustimmung zum Listen):
  ...
  Mycel-Raum (Schicht 1, gratis/neutral):
  ...
  Pilz-Raum (Schicht 2, die „Pilze/Gerichte"):
  ...
  Endknoten (Klaus' eigene Domänen-Apps, als lebende Pilz-Beispiele):
...
2. SB-KIMTool-Point datei-für-datei prüfen (Stand 2026-05-26: leer angelegt).
   Was fehlt: index.html (Landing/Observatorium light), status.json,
   Andock-Wizard-Sektion (Modul 19), Module-Kopien, Impressum/Datenschutz.
...
- Toolpoint-Landing-Page in SB-KIMTool-Point mit den DREI Räumen sichtbar
  getrennt (Mycel / Pilz / Marktplatz). Empfehlung Präsentation: Vorteilspack-
  Truhe-Mechanik wiederverwenden + frische, einladende Außenhülle/Sprache für
  Nicht-Techniker (Klaus' Auswahl am Sitzungsstart bestätigen lassen).
- Mycel-Raum: Andock-Wizard (Modul 19) eingebettet + ehrliche Relay-Erklärung
  (dreistufiges prüfbares Versprechen aus notiz-toolpoint-relay.md).
- Pilz-Raum: Tools als Tiles/Karten, Klick → Detail (Truhe-9-Sektionen-Muster);
  Download-Knopf pro Tool. Such-Tool prominent als Discovery-Einstieg.
...
- Präsentationsform: Truhe-Mechanik + frische Schauseite (Vorschlag) ODER
  ganz neue Form?
...
Empfangsmodus gilt fürs Mycel (Schicht 1) — die Pilz-/Marktplatz-Schicht
