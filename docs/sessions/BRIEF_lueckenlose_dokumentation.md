...
| Der **Arbeitszeit-Nachweis** | `docs/historie/arbeitstage.*` | 128 Tage, aus fremden Zeitstempeln |
...
Es existiert nicht, und **wer die Untersuchung liest, braucht es zuerst**. Eine Seite: was
