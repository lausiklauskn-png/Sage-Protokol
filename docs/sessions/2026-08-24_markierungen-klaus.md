# Klaus' Markierungen in der Antragsmappe, 2026-08-24

Ausgelesen aus `docs/antragsmappe.html` am 2026-08-24, Stand der Mappe
2026-08-23. **100 Markierungen: 44 grün, 40 gelb, 16 rot.**

Was die Farben heißen (Klaus 2026-08-24): **grün** soll bleiben, **gelb** kann
bleiben oder weg und Claude wägt ab, **rot** kann komplett weg.
**Im Zweifel bleiben.**

> Diese Datei ist der **Beleg**, nicht die Arbeit. Sie hält fest, was Klaus
> angestrichen hat, und was daraus geworden ist. Die Markierungen in seinem
> Browser sind mit der ersten Runde großenteils verwaist, weil sich der Text
> darunter geändert hat. Genau dafür gibt es die Auslese: sie überlebt den
> Umbau, die Markierung selbst nicht.

---

## Rot: erledigt am 2026-08-24

Sechzehn Stück. Elf davon waren in Paper A **die Gedankenstriche selbst**;
Klaus hat sie einzeln angestrichen. Sie sind mit dem Gedankenstrich-Durchgang
verschwunden.

| Wo | Angestrichen | Was daraus wurde |
|---|---|---|
| PAPER A, elf Stellen | `—` | mit dem Durchgang aufgelöst |
| PAPER A, 2.3 | „und hier wird es für dieses Papier unangenehm." | gestrichen. Der Satz sagte etwas über den Schreiber, nichts über die Sache |
| FÖRDERUNG, 2.3 | „dazu" | gestrichen |
| FÖRDERUNG, 2.3 | „, nicht die kleinere" | gestrichen. Die Aussage steht allein |
| FÖRDERUNG, 2.3 | „Deine", Notiz *Meine* | geändert in „Meine" |
| FÖRDERUNG, 5d | „und keine Hoffnung." | gestrichen |
| FÖRDERUNG, 5d | „kein neues Muster, sondern" | gestrichen. Jetzt: „Das ist das erprobte Muster dieses Netzes." |
...
| Wo | Angestrichen | Klaus' Notiz |
|---|---|---|
| FÖRDERUNG 2.1 | „funktionierender Verbund aus rund zwei Dutzend Apps …" | nicht nur kommerzielle Firmen, sondern standortübergreifend Privatpersonen, Vereine, Organisationen, Behörden und andere Institute |
| FÖRDERUNG 2.3 | „ein Werkzeug, das nie ‚nein'" | Claude sagt ab und zu nein, aber KI ermuntert immer weiterzumachen und sucht sehr lange einen Ausweg, bis es wirklich keinen mehr gibt. Der Mensch hätte längst aufgegeben |
| FÖRDERUNG 2.3 | „Forschung" | Forschungen |
| FÖRDERUNG 2.3 | „kämpfen" | kämpft |
| FÖRDERUNG 2.3 | „nie widerspricht, nie etwas zurückfordert." | selten widerspricht und zurückfordert |
| FÖRDERUNG 4 | „3, Sage-Protokol, SB-KIMTool-Point, mycel-karte" | andere Repos wurden auch zu Open Source erklärt |
...
Vierundvierzig Stück, nichts zu tun. Sie sind trotzdem eine Auskunft: sie
zeigen, welche Teile des Fahrplans Klaus für tragfähig hält. Der Schwerpunkt
liegt bei der **Abgrenzung gegen bestehende Technik** (semantische Suche gibt es,
aber sie gehört immer jemandem; Peer-to-peer gibt es, aber ohne
Bedeutungsverständnis; SBKIM setzt beides zusammen), bei den **Wegen selbst**
(Prototype Fund, Forschungszulage, OTF) und bei **BYOK** als Antwort auf die
Tragfähigkeitsfrage.
