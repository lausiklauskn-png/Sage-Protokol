...
|---|---|---|---|
| **1** | Fahrplan Forschungsgelder | `docs/FORSCHUNGSFOERDERUNG.md`, 1.403 Zeilen | Stand 24.08. |
| **1b** | Die Schritte, abhakbar | `docs/unterlagen/01_SCHRITTE.md` | 26.08. |
| **2** | Frageblatt Steuerberater | `docs/STEUERBERATER_FRAGEN.md`, `frageblatt.pdf` | 24.08. |
| **3** | Vorbereitung Finanzamt | `docs/unterlagen/03_FINANZAMT.md` | 26.08. |
| **4** | Arbeitszeitnachweis, Tag für Tag | `docs/historie/arbeitstage.*`, 301 Seiten | 10.03. bis 24.08. |
| **5** | Forschungsunterlagen inkl. Paper A | `docs/antragsmappe.html`, Abteilung 2 | 24.08. |
...
Steuerberater-Blätter hätten einander nicht widersprochen, sie wären nur zwei
...
1. **Das ELSTER-Zertifikat.** Zehn Minuten beantragen, dann kommt ein Brief.
   Solange er nicht da ist, geht der Fragebogen nicht ab, und ohne Steuernummer
   sind Weg 1 und Weg 2 beide zu.
2. **Der Steuerberater-Termin**, mit dem Frageblatt. Er gehört **vor** den
...
| | Stand |
|---|---|
| Blatt „Stand der Technik und Abgrenzung" | **existiert nicht.** Jede Fördergeberin liest es zuerst |
| Englische Projektseite | **existiert nicht.** Grundlage für den OTF-Antrag |
