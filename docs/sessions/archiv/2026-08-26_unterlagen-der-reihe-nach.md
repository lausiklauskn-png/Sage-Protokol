...
Download-Dokumente: Fahrplan, Fragen-Blatt, Behörden-Blatt,
Arbeitszeit-Nachweis, Forschungsunterlagen inkl. Papers, und was noch fehlt für
...
|---|---|---|
| 1 | Fahrplan | der Fahrplan, 1.403 Zeilen |
| 2 | Fragen-Blatt | existierte nicht, **kam parallel von der Nachbarsitzung** |
| 3 | Behörden-Blatt | **existierte nicht** |
| 4 | Arbeitszeit-Nachweis | `docs/historie/arbeitstage.*` |
...
| das Behörden-Blatt | Vorbereitung, **keine Abschrift des Formulars** |
| die Unterlagen-Mappe | vier Abteilungen, jede einzeln zu haben |
...
- **Das Blatt „Stand der Technik und Abgrenzung".** Es existiert nicht, und
  **wer die Untersuchung liest, braucht es zuerst.** Von allem Fehlenden das mit der
  größten Wirkung je Seite.
- **Die englische Projektseite**, Grundlage für die englischsprachige Fassung.
- **Paper B und C**, geplant, nicht geschrieben. Für den Antrag reicht A.
- **Die Anmeldung nach § 5c**, und darin das ein Behörden-Schritt als Engpass.
