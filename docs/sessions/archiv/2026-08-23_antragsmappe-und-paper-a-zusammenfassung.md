...
## 2 · Die Auslieferung: `docs/antragsmappe.html`
...
`docs/FORSCHUNGSFOERDERUNG.md` in einem öffentlichen Depot, und die Mappe liegt
...
- **Punkt 1 und 4 des Briefes sind Klaus' Sache** (Steuerberater, ELSTER, ORCID,
...
4. **ELSTER-Zertifikat** (A2b) parallel zum Steuerberater-Termin. Der Brief
