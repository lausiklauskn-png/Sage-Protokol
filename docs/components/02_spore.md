...
| Sichttest (Bau 02.X) | 2026-05-16 | Bau 02.X Backup-Export | ungeprüft, weil headless gebaut — wartet auf Klaus' Browser-Lauf. Klaus' Sichttest bringt die plattform-spezifische Antwort: PBKDF2-600 000-Aufruf-Zeit auf Galaxy Tab S6 (Ziel: ≤ 2 s), AES-GCM-Verhalten in Safari iOS (sollte den `CryptoUnavailableError`-Pfad nicht treffen — AES-GCM ist älter als Ed25519 im WebCrypto-Support). |
