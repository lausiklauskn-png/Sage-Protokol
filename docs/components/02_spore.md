...
| Sichttest (Bau 02.Y) | 2026-05-19 | Bau 02.Y Multi-Identitäts-API + Backup-Schema-Bump | **ungeprüft, weil headless gebaut — wartet auf Klaus' Browser-Lauf** der drei neuen Panel-02-Knöpfe (Drei-Stufen-Probe: Identität anlegen + wechseln / removeIdentity force-Fallback auf main / Backup mit `identities.length === 2`). |
