...
| Sichttest (Bau 04.F) | — | Klaus | **ausstehend** — Panel-04-Messung (Schritt 0 Baseline: KALIBRIER-BODEN / SCHWELLEN-ANALYSE / VERFAHREN-VERGLEICH) + Hybrid-Vergleich am realen Korpus, wartet auf Klaus' Browser-Lauf. Headless 32/32 grün ersetzt den Browser-Sichttest nicht. |
