...
| Sichttest (Bau 04.F) | — | Klaus | **ausstehend** — **Panel 04 Test 20** (2026-07-01 ergänzt) „Hybrid BM25+Vektor" zeigt den Kern-Hebel am Mini-Korpus (Standard verwirft den Unter-Boden-Treffer, Hybrid findet ihn über den Wort-Treffer) — nutzt denselben SbkimEmbedding-Mock wie Tests 11–15, kein Modell-Lade. Plus Schritt-0-Baseline (KALIBRIER-BODEN / SCHWELLEN-ANALYSE / VERFAHREN-VERGLEICH). Wartet auf Klaus' Browser-Lauf; Headless 32/32 grün ersetzt ihn nicht. |
