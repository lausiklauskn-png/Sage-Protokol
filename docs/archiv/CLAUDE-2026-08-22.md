<!-- ARCHIV — nicht bearbeiten.
Das ist die vollständige CLAUDE.md von Sage-Protokol im Stand vom 2026-08-22,
unverändert, bevor sie aufgeteilt wurde. Die geltenden Fassungen stehen in
../../CLAUDE.md (kurz), ../LEHREN.md (die Lehren), ../NETZWEIT.md (was für alle
Repos gilt), ../MODUL-STAND.md und ../PIPELINE.md.
Aufbewahrt, weil hier Sätze stehen, die aus echtem Schaden entstanden sind.
-->
