...
> **⚠ Wer andockt, entscheidet nebenbei über die SPRACHE** (seit 2026-09-14).
> **23-UI** (Verbinden-Fenster, 237 Texte), **16** (Siegel, 55) und **17**
> (Lampen, 28) sprechen Deutsch und Englisch. Ein Voll-Knoten ist damit
...
> ⚠ **`lang` geht an DREI Aufrufe** — 23-UI, 16 und 17 starten getrennt, und
> keiner reicht ihn an die anderen weiter. Über `<html lang>` entfällt das:
> alle drei lesen das Attribut selbst.
>
...
> Nutzer nichts. Verträge: [`INTERFACES.md`](INTERFACES.md) § Modul 23 UI ·
> § Modul 16 SPRACHE · § Modul 17 SPRACHE.
>
> > **Bis zum 2026-09-14 stand hier, ein englischsprachiger Knoten sei
> > „gemischtsprachig"** — englisches Fenster, deutsche Lampen, deutsches
> > Siegel. Das galt fünf Tage und ist mit dem Sprach-Haken für 16/17 erledigt.
> > Wer eine ältere Kopie der Module trägt, findet den alten Zustand aber
> > weiterhin vor.
