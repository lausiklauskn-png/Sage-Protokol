...
| **WorkFloh** (digitaler Werbetechnik-Auftragszettel; seit 2026-07-25 öffentlich angeboten) | Werbetechnik-Auftragsabwicklung (`lausiklauskn-png.github.io/Mein-WorkFloh/`) | `6YOPHbnKWreoF5og4PGc3fre7du1FhVc7dY1d5jZyHs` (echt, Browser); frühere Platzhalter-ID `PuOH7u8K…` ersetzt | **`verified-match` 0.833465** (2026-07-25 **Klaus' Browser-Andock — funktionierender Knoten**; echte v0.2-Spore über den Andock-Wizard im Siegel erzeugt+committet, headless reziprok verifiziert ✔ VALID; echter `domainVector` 384-dim L2=1 + 3 Schnipsel, kein `_demo`. **✅ Live-Beleg** Mycel-Analyse 2026-07-25 18:21–18:33: „WorkFloh · Klaus Tablet" live im Raum `sbkim-rdv` mit 13 weiteren Knoten. Echte Cross-Knoten-Matches: **Tomys-Hub 0.8335 · Kimseek 0.8110** ≥ 0.80 (fachverwandt Werbetechnik/Druck); Sage 0.7824 < 0.80 → **kein direkter Sage-Match** (fachfremd zum Hub, wie Tomys)) | `Mein-WorkFloh/sbkim/spore.json` (echt, VALID) + Mycel-Analyse-Rekord 2026-07-25 |
...
| WorkFloh ⟷ Tomys Hub | **0.833465** | 2026-07-25 (15. Knoten, echter Vektor; fachverwandt Werbetechnik/Druck **ohne** den Hub Sage — Sage⟷WorkFloh 0.7824 < 0.80; offline nachgerechnet, WorkFloh live im Raum bewiesen) |
| WorkFloh ⟷ Kimseek | **0.811031** | 2026-07-25 (echter Vektor; offline nachgerechnet, WorkFloh live im Raum bewiesen) |
